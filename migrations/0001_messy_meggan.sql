...
CREATE TABLE `__new_cash_adjustments` (
	...
	`created_at` integer DEFAULT '"2025-08-05T16:15:29.060Z"',
...
CREATE TABLE `__new_config` (
	...
	`key` text NOT NULL,
	`value` text NOT NULL,
	`updated_at` integer DEFAULT '"2025-08-05T16:15:29.059Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_payment_config` (
	...
	`created_at` integer DEFAULT '"2025-08-05T16:15:29.060Z"',
	`updated_at` integer DEFAULT '"2025-08-05T16:15:29.060Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_products` (
	...
	`created_at` integer DEFAULT '"2025-08-05T16:15:29.059Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_shift_collaborators` (
	...
	`user_id` integer NOT NULL,
	`added_at` integer DEFAULT '"2025-08-05T16:15:29.059Z"',
	FOREIGN KEY (`shift_id`) REFERENCES `shifts`(`id`) ON UPDATE no action ON DELETE no action,
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
INSERT INTO `__new_shift_collaborators`("id", "shift_id", "user_id", "added_at") SELECT "id", "shift_id", "user_id", "added_at" FROM `shift_collaborators`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_shifts`("id", "user_id", "start_time", "end_time", "initial_cash", "initial_coins", "final_cash", "final_coins", "gas_exchange", "notes", "cash_divergence", "closed_by", "total_sales", "status", "expected_cash", "counted_cash", "counted_coins", "inherited_from_shift_id", "temp_final_cash", "temp_final_coins", "temp_gas_exchange", "created_at") SELECT "id", "user_id", "start_time", "end_time", "initial_cash", "initial_coins", "final_cash", "final_coins", "gas_exchange", "notes", "cash_divergence", "closed_by", "total_sales", "status", "expected_cash", "counted_cash", "counted_coins", "inherited_from_shift_id", "temp_final_cash", "temp_final_coins", "temp_gas_exchange", "created_at" FROM `shifts`;--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`created_at` integer DEFAULT '"2025-08-05T16:15:29.058Z"',
