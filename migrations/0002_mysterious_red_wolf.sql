CREATE TABLE `corrections` (
	...
	`evidence_url` text,
	`applied_at` integer DEFAULT '"2025-08-08T02:36:50.946Z"',
	`revoked_at` integer,
...
CREATE TABLE `__new_cash_adjustments` (
	...
	`created_at` integer DEFAULT '"2025-08-08T02:36:50.946Z"',
	FOREIGN KEY (`shift_id`) REFERENCES `shifts`(`id`) ON UPDATE no action ON DELETE no action,
...
CREATE TABLE `__new_config` (
	...
	`key` text NOT NULL,
	`value` text NOT NULL,
	`updated_at` integer DEFAULT '"2025-08-08T02:36:50.946Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_products` (
	...
	`created_at` integer DEFAULT '"2025-08-08T02:36:50.945Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_shift_collaborators` (
	...
	`shift_id` integer NOT NULL,
	`user_id` integer NOT NULL,
	`added_at` integer DEFAULT '"2025-08-08T02:36:50.945Z"',
	FOREIGN KEY (`shift_id`) REFERENCES `shifts`(`id`) ON UPDATE no action ON DELETE no action,
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `__new_transport_modes` (
	...
	`created_at` integer DEFAULT '"2025-08-08T02:36:50.945Z"',
	`updated_at` integer DEFAULT '"2025-08-08T02:36:50.945Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`created_at` integer DEFAULT '"2025-08-08T02:36:50.944Z"',
